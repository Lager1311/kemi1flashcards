...
const PROBLEMS = [
  ...
  { id:101, lv:1, cat:'mol', title:'Substansmängd från massa',
    ...
    steps:['Känd data: massa m = 36 g, molmassa M(H₂O) = 18 g/mol','Formel: n = m/M — substansmängd = massa delat med molmassa (g ÷ g/mol = mol)','Beräkna: n = 36 g ÷ 18 g/mol = 2,0 mol','Svar: 2,0 mol vatten. Varje mol H₂O väger 18 g, så 36 g = 2 portioner = 2 mol'] },
  ...
  { id:104, lv:2, cat:'mol', title:'Molmassa från mätning',
    ...
    steps:['Känd data: massa m = 5,85 g, substansmängd n = 0,100 mol','Formel: M = m/n — molmassa = massa / substansmängd (g ÷ mol = g/mol)','Beräkna: M = 5,85 g ÷ 0,100 mol = 58,5 g/mol','Svar: 58,5 g/mol → identifierbar som NaCl (Na=23 + Cl=35,5 = 58,5 g/mol) ✓'] },
  { id:105, lv:2, cat:'mol', title:'Empirisk formel – H/C-kvot',
    ...
    steps:['Känd data: procenthalt H = 14,3 %, C = 85,7 % — omvandla till molförhållande','n(H) = 14,3/1,0 = 14,3 mol;  n(C) = 85,7/12,0 = 7,14 mol','Kvot n(H)/n(C) = 14,3/7,14 ≈ 2,0 — dvs 2 väteatomer per kolatom','Svar: Empirisk formel CH₂ (t.ex. eten C₂H₄ eller cyklohexan C₆H₁₂). Empirisk = enklaste heltalskvoter'] },
  { id:106, lv:3, cat:'mol', title:'Molekylformel från empirisk formel',
    ...
    steps:['Känd data: empirisk formel CH₂O (M_emp = 12+2+16 = 30 g/mol); mätt M_mol = 180 g/mol','Multiplikator n = M_mol / M_emp = 180 / 30 = 6','Molekylformel = 6 × (CH₂O) = C₆H₁₂O₆','Svar: glukos C₆H₁₂O₆. Empirisk formel ger bara atomförhållandet — molekylformeln ger faktiskt antal'] },
  // ── KONCENTRATION
  ...
  { id:203, lv:1, cat:'konc', title:'Spädning',
    ...
    steps:['Känd data: c₁ = 5,0 mol/L; V₁ = 100 mL = 0,10 L; V₂ = 500 mL = 0,50 L','Princip: substansmängden ändras INTE vid spädning → c₁V₁ = c₂V₂','Beräkna: c₂ = c₁V₁/V₂ = (5,0 × 0,10) / 0,50 = 0,50/0,50 = 1,0 mol/L','Svar: 1,0 mol/L. Volymen femfaldigades → koncentrationen minskade till 1/5'] },
  { id:204, lv:2, cat:'konc', title:'Blanda lösningar',
    ...
    steps:['Känd data: lösn 1: c₁=1,0 mol/L, V₁=200 mL=0,20 L; lösn 2: c₂=3,0 mol/L, V₂=300 mL=0,30 L','Total substansmängd: n_tot = c₁V₁ + c₂V₂ = (1,0×0,20) + (3,0×0,30) = 0,20 + 0,90 = 1,10 mol','Total volym: V_tot = 0,20 + 0,30 = 0,50 L','Svar: c = 1,10/0,50 = 2,2 mol/L. Blandning av lösningar: räkna alltid n_tot och V_tot separat'] },
  { id:205, lv:2, cat:'konc', title:'Neutralisationstitrering',
    ...
    steps:['Känd data: NaOH: V=25,00 mL=0,02500 L, c=0,100 mol/L; HCl: V=20,00 mL=0,02000 L','Vid neutralisation (1:1): n(HCl) = n(NaOH). HCl + NaOH → NaCl + H₂O','n(NaOH) = 0,100 × 0,02500 = 2,50×10⁻³ mol = n(HCl)','Svar: c(HCl) = n/V = 2,50×10⁻³ / 0,02000 = 0,125 mol/L. Titrering ger exakt c vid ekvivalenspunkten'] },
  { id:206, lv:3, cat:'konc', title:'Diprotisk syra – titrering',
    ...
    steps:['Känd data: H₂SO₄ är diprotisk (tvåprotonig) → 1 mol H₂SO₄ neutraliserar 2 mol NaOH','Reaktion: H₂SO₄ + 2NaOH → Na₂SO₄ + 2H₂O — molförhållande 1:2','n(NaOH) = 0,200 mol/L × 0,030 L = 0,00600 mol → n(H₂SO₄) = 0,00600/2 = 0,00300 mol','Svar: c(H₂SO₄) = 0,00300 / V_syra. OBS: diprotisk syra kräver dubbelt så mycket NaOH per mol'] },
  // ── GASLAGAR
  ...
  { id:303, lv:1, cat:'gas', title:'Charles lag',
    ...
    steps:['Känd data: V₁=3,0 L, T₁=300 K, T₂=450 K; tryck konstant (isobar process)','Charles lag: V₁/T₁ = V₂/T₂ — volym och temperatur direkt proportionella vid konstant p','Beräkna: V₂ = V₁ × T₂/T₁ = 3,0 × 450/300 = 3,0 × 1,5 = 4,5 L','Svar: 4,5 L. T ökade 50% → V ökade 50%. OBS: ALLTID Kelvin i gaslagsberäkningar!'] },
  ...
  { id:305, lv:2, cat:'gas', title:'Gay-Lussacs lag',
    ...
    steps:['Känd data: p₁=100 kPa, T₁=300 K, T₂=450 K; volym konstant (isokor process)','Gay-Lussacs lag: p₁/T₁ = p₂/T₂ — tryck och temperatur direkt proportionella vid konstant V','Beräkna: p₂ = p₁ × T₂/T₁ = 100 × 450/300 = 100 × 1,5 = 150 kPa','Svar: 150 kPa. Mer rörelseenergi (hög T) → fler kollisioner med väggarna → högre tryck'] },
  { id:306, lv:3, cat:'gas', title:'Kombinerade gaslagen',
    ...
    hint:'V₂ = V₁ × (p₁/p₂) × (T₂/T₁)',
    steps:['Känd data: p₁=100 kPa, V₁=5,0 L, T₁=300 K; p₂=200 kPa, T₂=400 K','Kombinerade gaslagen: (p₁V₁)/T₁ = (p₂V₂)/T₂ — alla tre variabler ändras','Beräkna: V₂ = (p₁V₁T₂)/(T₁p₂) = (100 × 5,0 × 400) / (300 × 200) = 200000/60000 = 3,33 L','Svar: 3,33 L. Tryckfördubbling halverar volymen; temperaturökning (+33%) verkar mot. Netto: 3,33 L'] },
  // ── TERMODYNAMIK
  ...
  { id:403, lv:2, cat:'termo', title:'Kalorimeter',
    ...
    steps:['Känd data: m=200 g vatten i kalorimeter, c=4,18 J/(g·K); mätt ΔT=+5,0°C','Q_vatten = m·c·ΔT = 200 × 4,18 × 5,0 = 4180 J (vattnet värms upp = tar emot energi)','Reaktionens entalpiändring: ΔH_rxn = −Q_vatten = −4180 J = −4,18 kJ','Svar: ΔH = −4,18 kJ (exoterm reaktion). Minustecken: reaktionen avger energi till vattnet'] },
  { id:404, lv:2, cat:'termo', title:'Hesss lag',
    ...
    steps:['Hess lag: ΔH°rxn = ΣΔH°f(produkter) − ΣΔH°f(reaktanter). Reaktionsvägen spelar ingen roll!','Förbränning CH₄: CH₄ + 2O₂ → CO₂ + 2H₂O. ΔH°f: CO₂=−393,5; H₂O(l)=−285,8; CH₄=−74,8; O₂=0','Produkter: −393,5 + 2×(−285,8) = −393,5 − 571,6 = −965,1 kJ','Svar: ΔH° = −965,1 − (−74,8) = −890,3 kJ/mol. Exoterm förbränning frigör 890 kJ per mol metan'] },
  { id:405, lv:3, cat:'termo', title:'Gibbs fria energi',
    ...
    steps:['Känd data: ΔH = −86 kJ/mol; ΔS = −170 J/(mol·K) = −0,170 kJ/(mol·K); T = 298 K','Formel: ΔG = ΔH − TΔS. Om ΔG < 0 → spontan; ΔG > 0 → ej spontan; ΔG = 0 → jämvikt','Beräkna TΔS: T×ΔS = 298 × (−0,170) = −50,7 kJ/mol','Svar: ΔG = −86 − (−50,7) = −86 + 50,7 = −35,3 kJ/mol < 0 → spontan vid 298 K. ΔH gynnar, ΔS missgynnar'] },
  { id:406, lv:3, cat:'termo', title:'Spontanitetsgräns',
    ...
    steps:['Spontanitetsgräns: ΔG = 0 när ΔH = TΔS → T_gräns = ΔH/ΔS','Känd data: ΔH = +120 kJ/mol; ΔS = +0,400 kJ/(mol·K)','Beräkna: T_gräns = 120/0,400 = 300 K','Svar: T > 300 K → spontan (entropin dominerar). T < 300 K → ej spontan. ΔG = 0 exakt vid 300 K'] },
  // ── SYRA-BAS
  ...
  { id:503, lv:1, cat:'syrabas', title:'pOH och pH',
    ...
    steps:['Känd data: pOH = 5,0. Samband: pH + pOH = 14 vid 25°C (härleds ur Kw=[H⁺][OH⁻]=10⁻¹⁴)','Formel: pH = 14 − pOH','Beräkna: pH = 14 − 5,0 = 9,0','Svar: pH = 9,0 (basisk). Varför 14? −log(Kw) = −log(10⁻¹⁴) = 14. OBS: gäller bara vid 25°C!'] },
  ...
  { id:505, lv:2, cat:'syrabas', title:'pH – stark bas',
    ...
    steps:['Känd data: stark bas NaOH c=0,050 mol/L → fullständig dissociation: [OH⁻] = 0,050 mol/L','pOH = −log[OH⁻] = −log(0,050) = −log(5,0×10⁻²) = −(log5,0 + log10⁻²) = −(0,699−2) = 1,30','pH = 14 − pOH = 14 − 1,30 = 12,70','Svar: pH = 12,7 (starkt basisk). Stark bas = fullständig dissociation → enkel beräkning via pOH'] },
  { id:506, lv:3, cat:'syrabas', title:'Buffert-pH',
    ...
    steps:['Känd data: buffert HA/A⁻; [HA]=0,20 mol/L; [A⁻]=0,10 mol/L; Ka=1,8×10⁻⁵ → pKa = −log(1,8×10⁻⁵) = 4,74','Henderson-Hasselbalch: pH = pKa + log([A⁻]/[HA]) — använd för buffert','Beräkna: pH = 4,74 + log(0,10/0,20) = 4,74 + log(0,50) = 4,74 − 0,301 = 4,44','Svar: pH = 4,44. [HA]>[A⁻] → pH < pKa. Om [A⁻]=[HA]: pH=pKa. Buffert bäst vid pKa±1'] },
  // ── JÄMVIKT
  ...
  { id:602, lv:2, cat:'jamvikt', title:'Reaktionskvot Q',
    ...
    steps:['Reaktion: N₂O₄ ⇌ 2NO₂; aktuella konc: [NO₂]=0,40; [N₂O₄]=0,20 mol/L; Kc=0,36','Reaktionskvot Q = [NO₂]² / [N₂O₄] — samma form som Kc men med aktuella (ej nödvändigtvis jämvikts-)koncentrationer','Beräkna Q: Q = (0,40)²/0,20 = 0,16/0,20 = 0,80','Jämför: Q=0,80 > Kc=0,36 → för mycket produkter → reaktionen går BAKÅT för att nå jämvikt'] },
  { id:603, lv:2, cat:'jamvikt', title:'ICE-tabell',
    ...
    steps:['Reaktion: H₂ + I₂ ⇌ 2HI; start: [H₂]=[I₂]=1,0 mol/L; [HI]=0; Kc=49','ICE-tabell: I:1,0/1,0/0  C:−x/−x/+2x  E:(1−x)/(1−x)/2x','Kc=(2x)²/(1−x)²=49 → ta kvadratroten: 2x/(1−x)=7 → 2x=7−7x → 9x=7 → x=0,778 mol/L','Svar: [HI]=2×0,778=1,556≈1,56 mol/L; [H₂]=[I₂]=0,222 mol/L. Kontroll: (1,556)²/(0,222)²=49 ✓'] },
  ...
  { id:606, lv:3, cat:'jamvikt', title:'ICE med andragradsekvation',
    ...
    steps:['Reaktion: PCl₃ + Cl₂ ⇌ PCl₅; start: [PCl₃]=[Cl₂]=1,0 mol/L; [PCl₅]=0; Kc=1,0','ICE: I:1,0/1,0/0  C:−x/−x/+x  E:(1−x)/(1−x)/x','Kc = x/(1−x)² = 1,0 → x=(1−x)² → x²−3x+1=0 → x=(3−√5)/2 = (3−2,236)/2 = 0,382','Svar: [PCl₅]=0,38; [PCl₃]=[Cl₂]=0,62 mol/L. Andragradsekvation uppstår när man inte kan förenkla'] },
  // ── ELEKTROKEMI
  { id:701, lv:2, cat:'elkem', title:'Elektrolys – koppar',
    ...
    steps:['Känd data: I=2,0 A; t=30 min=1800 s; M(Cu)=63,5 g/mol; Cu²⁺+2e⁻→Cu (n_e=2 elektroner per Cu)','Faradays lag: m = (I×t×M)/(n_e×F), F=96485 C/mol. Laddning Q=I×t=2,0×1800=3600 C','Beräkna: m = (3600 × 63,5)/(2 × 96485) = 228600/192970 = 1,185 g','Svar: 1,19 g koppar avsätts. Varje mol e⁻ (96485 C) avsätter 63,5/2=31,75 g Cu'] },
  ...
  { id:705, lv:3, cat:'elkem', title:'Silvermassa vid elektrolys',
    ...
    steps:['Känd data: I=3,0 A; t=2,0 h = 7200 s; M(Ag)=107,9 g/mol; n_e=1 (Ag⁺+e⁻→Ag)','Faradays lag: m = (I×t×M)/(n_e×F)','Beräkna: m = (3,0 × 7200 × 107,9)/(1 × 96485) = 2330280/96485 = 24,15 g','Svar: 24,2 g silver. Industriell användning: silverblästring. Varje Coulomb deponerar M/(n_e×F) gram'] },
  { id:706, lv:3, cat:'elkem', title:'Nernst ekvation',
    ...
    steps:['Känd data: Zn/Cu-cell; E°=1,10 V; n=2; [Zn²⁺]=0,10 mol/L; [Cu²⁺]=1,0 mol/L','Reaktionskvot Q = [Zn²⁺]/[Cu²⁺] = 0,10/1,0 = 0,10 (oxidation av Zn; reduktion av Cu²⁺)','Nernst: E = E° − (0,0592/n)×log Q = 1,10 − (0,0592/2)×log(0,10)','Svar: E = 1,10 − 0,0296×(−1) = 1,10 + 0,030 = 1,13 V. Låg [Zn²⁺] minskar back-reaktion → höjer EMK'] },
  // ── STÖKIOMETRI
  ...
  { id:802, lv:1, cat:'stoik', title:'Förbränning av metan',
    ...
    hint:'CH₄:CO₂ = 1:1',
    steps:['Reaktion: CH₄ + 2O₂ → CO₂ + 2H₂O; m(CH₄)=16 g; M(CH₄)=16 g/mol; M(CO₂)=44 g/mol','n(CH₄) = 16/16 = 1,0 mol','Molförhållande: 1 mol CH₄ → 1 mol CO₂ (koeff. 1:1)','Svar: m(CO₂) = 1,0 mol × 44 g/mol = 44 g. Förbränning av metan: varje C-atom in → en CO₂-molekyl ut'] },
  { id:803, lv:2, cat:'stoik', title:'Begränsande reagens',
    ...
    steps:['Reaktion: N₂ + 3H₂ → 2NH₃; n(N₂)=2,0 mol; n(H₂)=4,5 mol','Hitta begränsande reagens: dividera tillgänglig mängd med koefficienten','N₂: 2,0/1 = 2,0;  H₂: 4,5/3 = 1,5 → H₂ ger lägst kvot → H₂ är det begränsande reagenset','n(NH₃) = n(H₂) × (2/3) = 4,5 × 2/3 = 3,0 mol. N₂ är i överskott: förbrukas 3,0/2×1=1,5 mol; 0,5 mol kvar'] },
  ...
  { id:805, lv:3, cat:'stoik', title:'Förbränningsanalys',
    ...
    steps:['Förbränningsanalys: bränn CₓHᵧ → mät massa CO₂ och H₂O för att bestämma C och H','Från CO₂: n(C) = m(CO₂)/M(CO₂) = m/44. Från H₂O: n(H) = 2×m(H₂O)/M(H₂O) = 2×m/18','Exempel: 0,44 g CO₂ → n(C)=0,010 mol; 0,18 g H₂O → n(H)=0,020 mol','Svar: H/C = 0,020/0,010 = 2 → empirisk formel CH₂ (t.ex. eten C₂H₄). Om O: n(O)=n_total−n(C)−n(H)'] },
  { id:806, lv:3, cat:'stoik', title:'Gas från reaktion vid STP',
    ...
    steps:['Känd data: n mol gas bildas; STP = 0°C (273 K) och 101,3 kPa; molvolym Vm = 22,4 L/mol','Formel: V = n × Vm(STP) — en mol idealgas upptar 22,4 L vid STP','Exempel: n=0,50 mol → V = 0,50 × 22,4 = 11,2 L','Svar: 11,2 L. OBS: vid SATP (25°C, 100 kPa): Vm=24,8 L/mol. Viktigt att ange vilket standardtillstånd!'] },
  ...
  { id:1007, lv:2, cat:'mol', title:'Empirisk formel – kolhydrat', q:'En förening innehåller 40 % C, 6,7 % H och 53,3 % O (massa%).\nBeräkna kvoten n(H) / n(C) i den empiriska formeln.', ans:2.0, tol:0.1, unit:'', formula:'n_x = %x / M_x', hint:'Beräkna n per 100 g: C=40/12, H=6,7/1, O=53,3/16. Dividera med minsta.', steps:['Beräkna mol av varje grundämne per 100 g: n(C)=40/12=3,33; n(H)=6,7/1=6,7; n(O)=53,3/16=3,33','Dividera med minsta värdet (3,33): C:1,0 H:2,0 O:1,0','Empirisk formel: CH₂O (enklaste heltalsförhållandet)','Svar: CH₂O — t.ex. formaldehyd eller glukos (C₆H₁₂O₆ = 6×CH₂O). Metod: massa% → n → dela med minst ✓'], sol:'n(H)/n(C) = 6,7/3,33 = 2,0' },
  ...
  { id:1107, lv:2, cat:'konc', title:'Blanda lösningar', q:'200 mL av 1,0 mol/L NaCl blandas med 300 mL av 0,50 mol/L NaCl.\nVad är koncentrationen i blandningen?', ans:0.7, tol:0.02, unit:'mol/L', formula:'c = (n₁+n₂)/(V₁+V₂)', hint:'Beräkna n₁ och n₂ separat, addera och dividera med total volym.', steps:['n₁ = c₁ × V₁ = 0,200 × 1,0 = 0,200 mol; n₂ = c₂ × V₂ = 0,300 × 0,50 = 0,150 mol','Total n = 0,200 + 0,150 = 0,350 mol; Total V = 1,0 + 0,50 = 1,50 L','c = n_total / V_total = 0,350 / 1,50','Svar: c = 0,233 mol/L. Blandning: addera mol och volymer separat ✓'], sol:'c = 0,35/0,50 = 0,70 mol/L' },
  ...
  { id:1109, lv:3, cat:'konc', title:'Titrering – c(NaOH)', q:'25,0 mL NaOH titreras med 0,100 mol/L HCl. Ekvivalenspunkten nås vid 18,5 mL HCl.\nBeräkna c(NaOH).', ans:0.074, tol:0.003, unit:'mol/L', formula:'c₁V₁ = c₂V₂', hint:'n(HCl) = c×V. n(NaOH) = n(HCl). c(NaOH) = n/V(NaOH).', steps:['Titrering: n(HCl) = c × V = 0,100 × 0,0185 = 0,00185 mol','HCl + NaOH → NaCl + H₂O. Molförhållande 1:1 → n(NaOH) = n(HCl) = 0,00185 mol','c(NaOH) = n / V = 0,00185 / 0,0200 = 0,0925 mol/L','Svar: c(NaOH) ≈ 0,0925 mol/L. Titrering bestämmer okänd koncentration ✓'], sol:'c(NaOH) = 0,00185/0,025 = 0,074 mol/L' },
  { id:1110, lv:3, cat:'konc', title:'Seriell spädning', q:'1,0 mol/L späds 1:100 (1 mL→100 mL) två gånger i rad.\nVad är -log(c) för slutkoncentrationen?', ans:4.0, tol:0.05, unit:'', formula:'c_n = c₀ / (faktor)ⁿ', hint:'c = 1,0 / (100×100) = 10⁻⁴ mol/L. -log(10⁻⁴) = 4.', steps:['Spädning 1: c₁ = 1,0 / 100 = 0,010 mol/L (faktor 100)','Spädning 2: c₂ = 0,010 / 100 = 1,0×10⁻⁴ mol/L (ytterligare faktor 100)','Total spädfaktor = 100 × 100 = 10 000×','Svar: c = 1×10⁻⁴ mol/L. Seriell spädning: multiplicera spädfaktorerna ✓'], sol:'-log(10⁻⁴) = 4,0' },
  ...
  { id:1202, lv:1, cat:'gas', title:'Boyles lag', q:'En gas: P₁ = 100 kPa, V₁ = 6,0 L. Trycket ökar till P₂ = 300 kPa vid konstant T.\nBeräkna V₂.', ans:2.0, tol:0.1, unit:'L', formula:'P₁V₁ = P₂V₂', hint:'V₂ = P₁V₁ / P₂.', steps:['Boyles lag: P₁V₁ = P₂V₂ (konstant T). Volymen minskar när trycket ökar','P₁ = 100 kPa, V₁ = 6,0 L, V₂ = 2,0 L','V₂ = P₁V₁/P₂ → P₂ = P₁V₁/V₂ = 100×6,0/2,0 = 300 kPa','Svar: P₂ = 300 kPa. Trycket tredubblas när volymen halveras ✓'], sol:'V₂ = 100×6,0/300 = 2,0 L' },
  ...
  { id:1311, lv:3, cat:'termo', title:'ΔG = ΔH − TΔS', q:'ΔH = −120 kJ/mol, ΔS = +200 J/(mol·K), T = 298 K.\nBeräkna ΔG i kJ/mol.', ans:-179.6, tol:2.0, unit:'kJ/mol', formula:'ΔG = ΔH − TΔS', hint:'Omvandla ΔS till kJ: 200 J = 0,200 kJ. ΔG = −120 − 298×0,200.', steps:['ΔG = ΔH − TΔS. OBS: ΔS måste omvandlas till kJ: 200 J/(mol·K) = 0,200 kJ/(mol·K)','ΔG = −120 − 298 × 0,200 = −120 − 59,6','Beräkna: ΔG = −179,6 kJ/mol','Svar: ΔG < 0 → spontan vid 298 K. Negativ ΔH och positiv ΔS → alltid spontan ✓'], sol:'ΔG = −120−59,6 = −179,6 kJ/mol (spontan)' },
  { id:1312, lv:3, cat:'termo', title:'Neutralisationsentalpi – kalorimetri', q:'100 mL 1,0 mol/L HCl + 100 mL 1,0 mol/L NaOH blandas i kalorimeter. ΔT = 6,85 °C.\nm(lösning) ≈ 200 g, c = 4,18 J/(g·K).\nBeräkna |ΔHneutr| per mol.', ans:57.3, tol:1.0, unit:'kJ/mol', formula:'|ΔH| = q/n = mcΔT/n', hint:'q = 200×4,18×6,85. n = 0,100 mol. ΔH = q/n.', steps:['q = m×c×ΔT = 200×4,18×6,85 = 5726,6 J','n(HCl) = n(NaOH) = 1,0×0,100 = 0,100 mol reagerar','ΔH_neutr = −q/n = −5726,6/0,100 = −57266 J/mol = −57,3 kJ/mol','Svar: ΔH ≈ −57 kJ/mol. Standardvärdet för stark syra + stark bas ≈ −57 kJ/mol ✓'], sol:'|ΔHneutr| = 5727/0,100/1000 = 57,3 kJ/mol' },
  ...
  { id:1601, lv:1, cat:'elkem', title:'E°cell – Zn/Cu', q:'Zn | Zn²⁺ || Cu²⁺ | Cu. E°(Cu²⁺/Cu) = +0,34 V, E°(Zn²⁺/Zn) = −0,76 V.\nBeräkna E°cell.', ans:1.1, tol:0.02, unit:'V', formula:'E°cell = E°katod − E°anod', hint:'Katod = Cu (reduceras), Anod = Zn (oxideras).', steps:['Oxidationstal bestäms av reglerna: monoatomig jon = laddning; O = −2; H = +1','Fe₂O₃: låt Fe = x. 2x + 3×(−2) = 0 → 2x = 6 → x = +3','Svar: Fe har oxidationstal +3 i Fe₂O₃','Kontroll: 2×(+3) + 3×(−2) = 6 − 6 = 0 (neutral förening) ✓'], sol:'E°cell = 0,34−(−0,76) = 1,10 V' },
  { id:1602, lv:1, cat:'elkem', title:'E°cell – Pb/Ag', q:'E°(Ag⁺/Ag) = +0,80 V, E°(Pb²⁺/Pb) = −0,13 V.\nBeräkna E°cell för Pb | Pb²⁺ || Ag⁺ | Ag.', ans:0.93, tol:0.02, unit:'V', formula:'E°cell = E°katod − E°anod', hint:'Ag reduceras (katod), Pb oxideras (anod).', steps:['Reduktion = minskat oxidationstal = upptagning av elektroner','Oxidation = ökat oxidationstal = avgivning av elektroner','Cu²⁺ + 2e⁻ → Cu: Cu²⁺ reduceras (tar emot elektroner)','Svar: Cu²⁺ reduceras. Katoden = reduktion i elektrokemisk cell ✓'], sol:'E°cell = 0,80−(−0,13) = 0,93 V' },
  { id:1603, lv:1, cat:'elkem', title:'Antal elektroner – Cl₂', q:'Cl₂ + 2e⁻ → 2Cl⁻. Hur många elektroner per Cl₂-molekyl?', ans:2.0, tol:0.05, unit:'e⁻', formula:'Halvreaktion anger e⁻', hint:'Direkt avläsning från halfreaktionen.', steps:['E°cell = E°katod − E°anod (katod = högre potential)','E°(Zn²⁺/Zn) = −0,76 V; E°(Cu²⁺/Cu) = +0,34 V','Katod = Cu (högre potential); anod = Zn','E°cell = +0,34 − (−0,76) = 0,34 + 0,76 = 1,10 V ✓'], sol:'n(e⁻) = 2 per mol Cl₂' },
  { id:1604, lv:1, cat:'elkem', title:'Massa Cu vid elektrolys', q:'I = 10 A, t = 9650 s. Cu²⁺ + 2e⁻ → Cu. M(Cu) = 63,5 g/mol. F = 96500 C/mol.\nBeräkna massa Cu deponerat.', ans:31.75, tol:0.5, unit:'g', formula:'m = (I×t×M) / (n×F)', hint:'Q = 10×9650 = 96500 C = 1 mol e⁻. Mol Cu = 0,5. m = 0,5×63,5.', steps:['Faradays lag: m = (I×t×M)/(n×F)','Q = I×t = 2,0 × 3600 = 7200 C. n(e⁻) = 2 (Cu²⁺ + 2e⁻ → Cu)','m = Q×M/(n×F) = 7200 × 63,5/(2 × 96500) = 457200/193000','m = 2,37 g Cu ✓'], sol:'m = 0,5×63,5 = 31,8 g' },
  { id:1605, lv:2, cat:'elkem', title:'Nernst – Cu²⁺/Cu', q:'Cu²⁺ + 2e⁻ → Cu. E° = +0,34 V. [Cu²⁺] = 0,010 mol/L.\nE = E° − (0,0592/n)×log Q. Beräkna E.', ans:0.399, tol:0.01, unit:'V', formula:'E = E° − (0,0592/n) × log[Cu²⁺]', hint:'Q = 1/[Cu²⁺] = 100. E = 0,34 − (0,0296)×log(100)... Eller: log Q = log(1/0,010) = 2. E = 0,34−0,0296×2.', steps:['ΔG° = −nFE°. n = 2, F = 96500, E° = 1,10 V','ΔG° = −2 × 96500 × 1,10 = −212300 J = −212,3 kJ','Svar: ΔG° = −212 kJ. Negativt → spontan galvanisk reaktion ✓'], sol:'E = 0,34 − 0,0296×log(1/0,010) → se beräkning' },
  { id:1606, lv:2, cat:'elkem', title:'Elektrolystid – Cu', q:'Hur lång tid krävs för att deponera 6,35 g Cu (M=63,5) med strömmen 5,0 A?\nCu²⁺+2e⁻→Cu. F=96500 C/mol.', ans:3860.0, tol:20.0, unit:'s', formula:'t = (m×n×F) / (M×I)', hint:'mol Cu = 6,35/63,5 = 0,1. mol e⁻ = 0,2. Q = 0,2×96500. t = Q/I.', steps:['mol Cu = 6,35/63,5 = 0,100 mol', 'Q = 0,200×96500 = 19300 C', 't = Q/I = 19300/5,0 = 3860 s'], sol:'t = 19300/5,0 = 3860 s' },
  { id:1607, lv:2, cat:'elkem', title:'E°cell – Cr/Au', q:'E°(Au³⁺/Au) = +1,50 V, E°(Cr³⁺/Cr) = −0,74 V.\nBeräkna E°cell för Cr | Cr³⁺ || Au³⁺ | Au.', ans:2.24, tol:0.02, unit:'V', formula:'E°cell = E°katod − E°anod', hint:'Au reduceras, Cr oxideras.', steps:['E°cell = E°(Au) − E°(Cr)', '= 1,50 − (−0,74)', '= 2,24 V'], sol:'E°cell = 1,50+0,74 = 2,24 V' },
  { id:1608, lv:2, cat:'elkem', title:'Massa Al vid elektrolys', q:'Al³⁺ + 3e⁻ → Al. I = 3,0 A, t = 9650 s. M(Al) = 27 g/mol. F = 96500 C/mol.\nBeräkna massa Al.', ans:2.7, tol:0.1, unit:'g', formula:'m = (I×t×M) / (n×F)', hint:'Q = 3×9650 = 28950 C. mol e⁻ = 0,300. mol Al = 0,100.', steps:['Q = 3,0×9650 = 28950 C', 'mol e⁻ = 28950/96500 = 0,300 mol', 'mol Al = 0,100 → m = 0,100×27 = 2,70 g'], sol:'m = 0,100×27 = 2,70 g' },
  { id:1609, lv:3, cat:'elkem', title:'ΔG från E°cell', q:'Zn/Cu cell: E°cell = 1,10 V, n = 2 elektroner. F = 96500 C/mol.\nBeräkna ΔG° i kJ.', ans:-212.3, tol:2.0, unit:'kJ', formula:'ΔG° = −nFE°', hint:'ΔG = −2×96500×1,10 J = −212300 J = −212,3 kJ.', steps:['ΔG° = −nFE°', '= −2×96500×1,10', '= −212300 J = −212,3 kJ'], sol:'ΔG° = −2×96500×1,10 = −212,3 kJ' },
  { id:1610, lv:3, cat:'elkem', title:'E vid pH 7 – O₂/H₂O', q:'O₂ + 4H⁺ + 4e⁻ → 2H₂O. E° = +1,23 V. pH = 7. p(O₂) = 1 atm.\nE = E° − (0,0592/4)×log(1/[H⁺]⁴). Beräkna E.', ans:0.816, tol:0.01, unit:'V', formula:'E = E° − 0,0592×pH/n × n = E° − 0,0592×pH', hint:'log Q = log(1/(10⁻⁷)⁴) = 28. E = 1,23 − (0,0148×28).', steps:['Q = 1/[H⁺]⁴ = (10⁷)⁴ = 10²⁸', 'E = 1,23 − (0,0592/4)×28', '= 1,23 − 0,0148×28 = 1,23−0,414 = 0,816 V'], sol:'E = 1,23−0,414 = 0,816 V vid pH 7' },
  { id:1611, lv:3, cat:'elkem', title:'Volym H₂ vid elektrolys', q:'2H₂O → 2H₂ + O₂. I = 2,0 A, t = 4825 s. F = 96500 C/mol.\nBeräkna volymen H₂ vid STP (22,4 L/mol).', ans:1.12, tol:0.05, unit:'L', formula:'V(H₂) = (I×t)/(2F) × 22,4', hint:'Q=9650 C. mol e⁻=0,1. 2e⁻→1H₂ → mol H₂=0,05. V=0,05×22,4.', steps:['Q = 2,0×4825 = 9650 C', 'mol e⁻ = 9650/96500 = 0,100 mol', 'mol H₂ = 0,050 → V = 0,050×22,4 = 1,12 L'], sol:'V(H₂) = 0,050×22,4 = 1,12 L' },
  { id:1612, lv:3, cat:'elkem', title:'Katodiskt skydd Zn/Fe', q:'E°(Fe²⁺/Fe) = −0,44 V, E°(Zn²⁺/Zn) = −0,76 V.\nZink används som offeranod för att skydda järn. Beräkna E°cell.', ans:0.32, tol:0.02, unit:'V', formula:'E°cell = E°(Fe) − E°(Zn)', hint:'Fe = katod (skyddas), Zn = anod (korroderar). E°cell = E°(Fe)−E°(Zn).', steps:['Katod: Fe (skyddas), Anod: Zn (korroderar)', 'E°cell = (−0,44) − (−0,76)', '= 0,32 V'], sol:'E°cell = −0,44+0,76 = 0,32 V' },
  { id:1613, lv:3, cat:'elkem', title:'Laddning per 3 mol Ag', q:'Ag⁺ + e⁻ → Ag. Hur stor laddning Q (C) passerar för att deponera 3,0 mol Ag?\nF = 96500 C/mol.', ans:289500.0, tol:100.0, unit:'C', formula:'Q = n × n_e × F', hint:'n_e = 1 per Ag. Q = 3,0×1×96500.', steps:['n(e⁻) = 1 per mol Ag', 'Q = 3,0 × 1 × 96500', 'Q = 289500 C'], sol:'Q = 3,0×96500 = 289500 C' },
  { id:1701, lv:1, cat:'stoik', title:'Mol NH₃ från N₂', q:'N₂ + 3H₂ → 2NH₃. Hur många mol NH₃ bildas av 3,0 mol N₂ (överskott H₂)?', ans:6.0, tol:0.1, unit:'mol', formula:'n(NH₃) = 2 × n(N₂)', hint:'1 mol N₂ → 2 mol NH₃.', steps:['N₂ : NH₃ = 1 : 2', 'n(NH₃) = 2 × 3,0', 'n(NH₃) = 6,0 mol'], sol:'n(NH₃) = 2×3,0 = 6,0 mol' },
  { id:1702, lv:1, cat:'stoik', title:'Massa CO₂ från kol', q:'C + O₂ → CO₂. 2,0 mol C förbränns. Beräkna massan CO₂ som bildas. M(CO₂) = 44 g/mol.', ans:88.0, tol:1.0, unit:'g', formula:'m = n × M', hint:'1 mol C → 1 mol CO₂. m = 2,0 × 44.', steps:['n(CO₂) = n(C) = 2,0 mol', 'm = n × M = 2,0 × 44', 'm = 88 g'], sol:'m(CO₂) = 2,0×44 = 88 g' },
  { id:1703, lv:1, cat:'stoik', title:'Massa H₂ för H₂O', q:'2H₂ + O₂ → 2H₂O. Beräkna massa H₂ som behövs för att bilda 3,6 g H₂O.\nM(H₂O)=18, M(H₂)=2 g/mol.', ans:0.4, tol:0.02, unit:'g', formula:'m(H₂) = n(H₂) × M(H₂)', hint:'n(H₂O)=3,6/18=0,2 mol. n(H₂)=n(H₂O)=0,2 mol. m=0,2×2.', steps:['n(H₂O) = 3,6/18 = 0,20 mol', 'n(H₂) = n(H₂O) = 0,20 mol (1:1)', 'm(H₂) = 0,20 × 2 = 0,40 g'], sol:'m(H₂) = 0,20×2 = 0,40 g' },
  { id:1704, lv:1, cat:'stoik', title:'Mol Fe från CO₂', q:'Fe₂O₃ + 3CO → 2Fe + 3CO₂. Om 6,0 mol CO₂ bildas, hur många mol Fe bildas?', ans:4.0, tol:0.1, unit:'mol', formula:'Fe : CO₂ = 2 : 3', hint:'2 mol Fe per 3 mol CO₂. n(Fe) = 6,0 × (2/3).', steps:['Fe : CO₂ = 2 : 3', 'n(Fe) = 6,0 × (2/3)', 'n(Fe) = 4,0 mol'], sol:'n(Fe) = 6,0 × 2/3 = 4,0 mol' },
  { id:1705, lv:2, cat:'stoik', title:'Massa NH₃ – perfekt stök.', q:'3H₂ + N₂ → 2NH₃. 6,0 g H₂ (n=3,0 mol) + 28 g N₂ (n=1,0 mol).\nBeräkna massa NH₃ som bildas. M(NH₃) = 17 g/mol.', ans:34.0, tol:0.5, unit:'g', formula:'n(NH₃) = 2 × n(N₂) el. (2/3)×n(H₂)', hint:'Perfekt stökiometri (3:1). n(NH₃)=2×1,0=2,0 mol.', steps:['3 mol H₂ : 1 mol N₂ → exakt stökiometrisk', 'n(NH₃) = 2 × 1,0 = 2,0 mol', 'm(NH₃) = 2,0 × 17 = 34 g'], sol:'m(NH₃) = 2,0×17 = 34 g' },
  { id:1706, lv:2, cat:'stoik', title:'Begränsande reagens – AlCl₃', q:'2Al + 3Cl₂ → 2AlCl₃. 54 g Al (n=2,0) + 142 g Cl₂ (n=2,0 mol).\nM(AlCl₃)=133,5. Beräkna massa AlCl₃.', ans:178.0, tol:3.0, unit:'g', formula:'Begränsande: Cl₂', hint:'2 mol Al kräver 3 mol Cl₂, men bara 2 mol Cl₂ finns → Cl₂ begränsar. n(AlCl₃)=2×(2/3)≈1,33 mol.', steps:['Cl₂ krävs: 2,0×(3/2)=3,0 mol, men bara 2,0 mol → Cl₂ begränsar', 'n(AlCl₃) = 2,0×(2/3) = 1,333 mol', 'm = 1,333 × 133,5 = 178 g'], sol:'Cl₂ begränsar → m(AlCl₃) = 1,333×133,5 = 178 g' },
  { id:1707, lv:2, cat:'stoik', title:'Överskott O₂', q:'CH₄ + 2O₂ → CO₂ + 2H₂O. 2,0 mol CH₄ blandas med 6,0 mol O₂.\nBeräkna massa överskotts-O₂. M(O₂)=32 g/mol.', ans:64.0, tol:1.0, unit:'g', formula:'m_överskott = n_överskott × M', hint:'O₂ behövs: 2×2,0=4,0 mol. Överskott: 6,0−4,0=2,0 mol.', steps:['O₂ som förbrukas = 2,0×2 = 4,0 mol', 'Överskott O₂ = 6,0−4,0 = 2,0 mol', 'm = 2,0 × 32 = 64 g'], sol:'m(överskott O₂) = 2,0×32 = 64 g' },
  { id:1708, lv:2, cat:'stoik', title:'Teoretisk massa Fe₂O₃', q:'4Fe + 3O₂ → 2Fe₂O₃. 112 g järn (n=2,0 mol). M(Fe₂O₃)=160 g/mol.\nBeräkna teoretisk massa Fe₂O₃.', ans:160.0, tol:2.0, unit:'g', formula:'n(Fe₂O₃) = ½ × n(Fe)', hint:'4 mol Fe → 2 mol Fe₂O₃. n(Fe₂O₃)=2,0×(2/4)=1,0 mol.', steps:['n(Fe₂O₃) = n(Fe) × (2/4) = 2,0 × 0,5 = 1,0 mol', 'm = 1,0 × 160', 'm = 160 g'], sol:'m(Fe₂O₃) = 1,0×160 = 160 g' },
  ...
  { id:1710, lv:3, cat:'stoik', title:'Förbränningsanalys – n(H)/n(C)', q:'En kolförening förbränns och ger 44 g CO₂ och 18 g H₂O.\nBeräkna kvoten n(H)/n(C).', ans:2.0, tol:0.05, unit:'', formula:'n(C) från CO₂, n(H) från H₂O', hint:'n(C)=44/44=1 mol. n(H)=2×18/18=2 mol.', steps:['n(CO₂) = 44/44 = 1,0 mol → n(C) = 1,0', 'n(H₂O) = 18/18 = 1,0 mol → n(H) = 2,0', 'n(H)/n(C) = 2,0/1,0 = 2,0'], sol:'n(H)/n(C) = 2,0 → empirisk formel CH₂' },
  { id:1711, lv:3, cat:'stoik', title:'Sekventiella reaktioner med utbyte', q:'A → 2B (utbyte 80 %). B → C (utbyte 90 %). Start: 1,0 mol A.\nHur många mol C bildas?', ans:1.44, tol:0.05, unit:'mol', formula:'n(C) = n(A)×2×0,80×0,90', hint:'n(B)=2×0,80=1,6 mol. n(C)=1,6×0,90.', steps:['n(B) = 1,0 × 2 × 0,80 = 1,6 mol', 'n(C) = 1,6 × 0,90', 'n(C) = 1,44 mol'], sol:'n(C) = 1,0×2×0,80×0,90 = 1,44 mol' },
  { id:1712, lv:3, cat:'stoik', title:'Teoretisk massa från utbyte', q:'Faktisk massa produkt = 7,4 g. Procentuellt utbyte = 37 %.\nBeräkna den teoretiska massan.', ans:20.0, tol:0.5, unit:'g', formula:'m_teor = m_faktisk / (utbyte/100)', hint:'m_teor = 7,4 / 0,37.', steps:['utbyte = faktisk/teoretisk → teoretisk = faktisk/utbyte', 'm_teor = 7,4 / 0,37', 'm_teor = 20 g'], sol:'m_teor = 7,4/0,37 = 20 g' },
  { id:1713, lv:3, cat:'stoik', title:'Begränsande reagens + utbyte', q:'2A + B → 3C. 4,0 mol A + 3,0 mol B. Utbyte 75 %. M(C) = 30 g/mol.\nBeräkna faktisk massa C.', ans:135.0, tol:2.0, unit:'g', formula:'m = n_teor × utbyte × M', hint:'A begränsar (behöver 2mol B, har 3mol B). n(C)_teor=4,0×(3/2)=6,0. n(C)_faktisk=6,0×0,75.', steps:['A begränsar (4,0 mol A behöver 2,0 mol B; 3,0 mol B i överskott)', 'n(C)_teor = 4,0 × (3/2) = 6,0 mol', 'n(C)_faktisk = 6,0×0,75=4,5 mol → m = 4,5×30 = 135 g'], sol:'m(C) = 4,5×30 = 135 g' },
  ...
  { id:2039, lv:2, cat:'konc', title:'Proppipeltering – mmol', q:'Pipettera 10,0 mL av 0,250 mol/L HCl. Hur många mmol HCl?', ans:2.5, tol:0.05, unit:'mmol', formula:'n = c × V', hint:'n = 0,250×0,010 = 0,0025 mol = 2,5 mmol.', steps:['n = c × V = 0,250 mol/L × 0,010 L = 0,0025 mol','Omvandla till mmol: 0,0025 mol × 1000 = 2,5 mmol','Svar: 2,5 mmol HCl','OBS: 10,0 mL = 0,010 L. mmol = mol × 10³ ✓'], sol:'n = 2,5 mmol' },
  ...
  { id:2049, lv:3, cat:'konc', title:'Jonkoncentration – Ca(OH)₂', q:'Mättat Ca(OH)₂: s = 0,020 mol/L. Beräkna [OH⁻].', ans:0.04, tol:0.002, unit:'mol/L', formula:'[OH⁻] = 2s', hint:'Ca(OH)₂ → Ca²⁺ + 2OH⁻.', steps:['Ca(OH)₂ → Ca²⁺ + 2OH⁻. Per mol Ca(OH)₂ ger 2 mol OH⁻','[OH⁻] = 2 × s = 2 × 0,020 = 0,040 mol/L','Svar: [OH⁻] = 0,040 mol/L = 0,04 mol/L','Kontroll: Ca(OH)₂ är starkt basisk, hög [OH⁻] rimligt ✓'], sol:'[OH⁻] = 0,040 mol/L' },
  ...
  { id:2055, lv:1, cat:'gas', title:'°C → K', q:'Omvandla 127 °C till Kelvin.', ans:400.0, tol:0.5, unit:'K', formula:'T(K) = T(°C) + 273', hint:'127 + 273 = 400 K.', steps:['Omvandlingsformel: T(K) = T(°C) + 273','T = 127 + 273 = 400 K','Svar: 400 K. Kelvin = absolut temperaturskala (0 K = absolut nollpunkt = −273°C)','OBS: Gaslagar kräver alltid Kelvin! ✓'], sol:'T = 400 K' },
  ...
  { id:2061, lv:2, cat:'gas', title:'Graham – N₂ vs CO₂', q:'Hur många gånger snabbare diffunderar N₂ (M=28) jämfört med CO₂ (M=44)?', ans:1.253, tol:0.05, unit:'gånger', formula:'r(N₂)/r(CO₂) = √(M(CO₂)/M(N₂))', hint:'√(44/28) = √1,571 ≈ 1,253.', steps:['Grahams lag: r(N₂)/r(CO₂) = √(M(CO₂)/M(N₂)) — lättare gas diffunderar snabbare','= √(44/28) = √1,571 = 1,253','Svar: N₂ diffunderar 1,25 gånger snabbare än CO₂','Intuition: N₂ (28 g/mol) är lättare än CO₂ (44 g/mol) → snabbare ✓'], sol:'r(N₂)/r(CO₂) = √(44/28) ≈ 1,25' },
  ...
  { id:2106, lv:2, cat:'syrabas', title:'Ka av svag syra', q:'0,20 mol/L HA-lösning har pH = 3,0. Beräkna Ka.', ans:5e-06, tol:3e-07, unit:'', formula:'Ka = [H⁺]²/c (approximation)', hint:'[H⁺]=10⁻³. Ka=(10⁻³)²/0,20=10⁻⁶/0,20=5×10⁻⁶.', steps:['[H⁺] = 10^(−pH) = 10⁻³ mol/L (pH = 3,0)','Ka = [H⁺]²/c ≈ (10⁻³)²/0,20 = 10⁻⁶/0,20 = 5×10⁻⁶','Svar: Ka = 5×10⁻⁶','Approximation giltig om α = [H⁺]/c = 10⁻³/0,20 = 0,5% < 5% ✓'], sol:'Ka = 5×10⁻⁶' },
  ...
  { id:2115, lv:3, cat:'syrabas', title:'pKb från pKa', q:'pKa(NH₄⁺) = 9,26. Beräkna pKb(NH₃) vid 25 °C.', ans:4.74, tol:0.05, unit:'', formula:'pKa + pKb = 14', hint:'pKb = 14 − 9,26 = 4,74.', steps:['Samband: pKa + pKb = pKw = 14 (vid 25°C)','pKb(NH₃) = pKw − pKa(NH₄⁺) = 14 − 9,26 = 4,74','Svar: pKb(NH₃) = 4,74','OBS: NH₃/NH₄⁺ är ett konjugatsyra-baspar. pKa(NH₄⁺) + pKb(NH₃) = 14 ✓'], sol:'pKb(NH₃) = 4,74' },
  ...
  { id:2138, lv:3, cat:'jamvikt', title:'Simultana jämvikter', q:'K₁ = 4,0. K₂ = 2,0 (omvänd). Reaktionerna adderas.\nBeräkna K_total.', ans:2.0, tol:0.05, unit:'', formula:'K_tot = K₁ × (1/K₂)', hint:'Omvänd reaktion 2: K = 1/2,0. K_tot = 4,0×(1/2,0) = 2,0.', steps:['K_total = K₁ × (1/K₂) — reaktion 2 är omvänd','= 4,0 × (1/2,0) = 4,0 × 0,50 = 2,0','Svar: K_total = 2,0','Omvänd reaktion: K_ny = 1/K_gammal. Addition → multiplication ✓'], sol:'K_tot = 2,0' },
  ...
  { id:2146, lv:1, cat:'jamvikt', title:'Kc – enkel dissociation', q:'AB ⇌ A + B. [AB]=0,50, [A]=0,10, [B]=0,10 mol/L.\nBeräkna Kc.', ans:0.02, tol:0.001, unit:'mol/L', formula:'Kc=[A][B]/[AB]', hint:'(0,10×0,10)/0,50=0,02.', steps:['AB ⇌ A + B. Kc = [A][B]/[AB]','= (0,10 × 0,10)/0,50 = 0,01/0,50 = 0,020','Svar: Kc = 0,020 mol/L','Litet K → AB är stabilt — dissociation är ogynnsam ✓'], sol:'Kc = 0,020' },
  ...
  { id:2178, lv:1, cat:'stoik', title:'Mol O₂ vid förbränning CH₄', q:'CH₄ + 2O₂ → CO₂ + 2H₂O.\n0,50 mol CH₄ förbränns. Hur många mol O₂ förbrukas?', ans:1.0, tol:0.03, unit:'mol', formula:'n(O₂)=2×n(CH₄)', hint:'1 mol CH₄ kräver 2 mol O₂.', steps:['Reaktion: CH₄ + 2O₂ → CO₂ + 2H₂O. CH₄:O₂ = 1:2','n(O₂) = 2 × n(CH₄) = 2 × 0,50 = 1,0 mol','Svar: 1,0 mol O₂ förbrukas','Förbränning kräver alltid O₂ — koefficienten anger exakt mängd ✓'], sol:'n(O₂) = 1,0 mol' },
...
,
  ...
  { id:2322, lv:3, cat:'konc', title:'Beer-Lambert med okänd ε', q:'Standard: c=5,0×10⁻⁴ mol/L ger A=0,25 (l=1 cm). Prov: A=0,45. Beräkna c(prov).', ans:0.0009, tol:5, unit:'mol/L', steps:['Beräkna ε: ε = A/(c×l) = 0,25/(5,0×10⁻⁴×1) = 500 L/(mol·cm)','Beräkna c prov: c = A/(ε×l) = 0,45/(500×1) = 9,0×10⁻⁴ mol/L','Svar: c = 0,00090 mol/L','OBS: kan också lösa med proportion: c_prov/c_std = A_prov/A_std ✓'] },
  ...
  { id:2403, lv:1, cat:'mol', title:'Antal atomer', q:'Hur många atomer finns i 0,50 mol Fe? (Nₐ=6,022×10²³)', ans:3.011e+23, tol:3, unit:'atomer', formula:'N = n·Nₐ', steps:['Känd data: n = 0,50 mol Fe, Nₐ = 6,022×10²³ mol⁻¹','Formel: N = n × Nₐ — antal atomer = mol × Avogadros tal','Beräkna: N = 0,50 × 6,022×10²³ = 3,011×10²³ atomer','Svar: 3,011×10²³ Fe-atomer. Nₐ ≈ 6×10²³ är antalet per mol ✓'] },
  ...
  { id:2424, lv:3, cat:'mol', title:'Titrering + mol', q:'En 0,250 g fast CaCO₃-prov (M=100) löses i 50,0 mL 0,100 mol/L HCl. Hur många mL 0,100 mol/L NaOH krävs för att titrera överskottet HCl?', ans:10, tol:3, unit:'mL', steps:['n(CaCO₃) = 0,250/100 = 0,00250 mol. CaCO₃ + 2HCl → CaCl₂ + H₂O + CO₂','n(HCl) tillsatt = 0,100 × 0,050 = 0,00500 mol','n(HCl) som reagerar med CaCO₃ = 2 × 0,00250 = 0,00500 mol → exakt förbrukat','Svar: 0 mL NaOH — inget HCl-överskott kvar! Kontroll: 2×0,00250 = 0,00500 ✓'], sol:'0 mL (exakt neutralisering)' },
  ...
  { id:2507, lv:1, cat:'jamvikt', title:'pH ur Ka', q:'Ka=1,8×10⁻⁵, c=0,10 mol/L CH₃COOH. pH = −log(1,34×10⁻³) = ?', ans:2.87, tol:3, unit:'', steps:['pH = −log([H⁺]) = −log(1,34×10⁻³)','= −(log(1,34) + log(10⁻³)) = −(0,127 − 3) = 2,873','Svar: pH ≈ 2,87','Kontroll: pH < 7 → sur lösning, rimligt för ättiksyra ✓'] },
  ...
  { id:2518, lv:2, cat:'jamvikt', title:'K för omvänd reaktion', q:'A⇌B har K=0,050. Vad är K för reaktionen B⇌A?', ans:20, tol:3, unit:'', formula:'K(omvänd) = 1/K(framåt)', steps:['K(omvänd reaktion) = 1/K(framåt)','K(B⇌A) = 1/K(A⇌B) = 1/0,050 = 20,0','Svar: K = 20,0','Omvänd reaktion: reciprokt K. Liten K(framåt) → stor K(bakåt) ✓'] },
  ...
  { id:2524, lv:3, cat:'jamvikt', title:'Sammansatt jämvikt', q:'Reaktion 1: A⇌B, K₁=2,0. Reaktion 2: B⇌C, K₂=5,0. K för A⇌C = ?', ans:10, tol:2, unit:'', formula:'K_tot = K₁ × K₂', steps:['K_total = K₁ × K₂ (reaktioner i serie multipliceras)','= 2,0 × 5,0 = 10,0','Svar: K(A⇌C) = 10,0','Addition av reaktioner → multiplikation av K-värden ✓'] },
